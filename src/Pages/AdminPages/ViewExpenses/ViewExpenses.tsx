...
const Expenses: React.FC = () => {
    ...
    useEffect(() => {
        const fetchExpenses = async () => {
            try {
                const response = await axios.get(`https://api-trx.linarawas.com/api/expenses/company/${companyId}`, {
                    headers: {
    ...
    const handleDeleteExpense = async (expenseId: string) => {
        try {
            const response = await fetch(`https://api-trx.linarawas.com/api/expenses/${expenseId}`, {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${token}`,
                },
