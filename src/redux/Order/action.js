...
import { SET_CUSTOMER_ID,SET_PRODUCT_PRICE, SET_PRODUCT_NAME,SET_AREA_ID,SET_PRODUCT_ID,CLEAR_PRODUCT_ID, CLEAR_CUSTOMER_ID, CLEAR_AREA_ID } from "./actionTypes.ts";
