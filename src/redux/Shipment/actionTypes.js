...
export const SET_SHIPMENT_PROFITS = 'SET_SHIPMENT_FROM_PREV';
export const SET_SHIPMENT_EXPENSES = 'SET_SHIPMENT_FROM_PREV';

// Action types for clearing day and date Info
export const CLEAR_DAY_ID = 'CLEAR_DAY_ID';
export const CLEAR_ID = 'CLEAR_ID';
export const CLEAR_SHIPMENT_PROFITS = 'CLEAR_SHIPMENT_PROFITS';
export const CLEAR_SHIPMENT_EXPENSES = 'CLEAR_SHIPMENT_EXPENSES';
