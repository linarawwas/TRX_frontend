...
export async function listDistributors(token: string) {
  const res = await fetch("https://trx-api.theagilelabs.com/api/distributors", {
...
export async function distributorsSummary(token: string, range: DateRange) {
  ...
  const res = await fetch(
    `https://trx-api.theagilelabs.com/api/distributors/summary?${qs.toString()}`,
    {
      headers: authHeaders(token),
    }
  );
...
export async function updateDistributor(
  ...
  const res = await fetch(`https://trx-api.theagilelabs.com/api/distributors/${id}`, {
    method: "PATCH",
    headers: authHeaders(token),
    body: JSON.stringify(payload),
  });
...
export async function distributorCustomers(token: string, id: string) {
  const res = await fetch(
    `https://trx-api.theagilelabs.com/api/distributors/${id}/customers`,
    {
      headers: authHeaders(token),
    }
  );
...
export async function distributorSummary(
  ...
  if (range.to) qs.set("to", range.to);
  const res = await fetch(
    `https://trx-api.theagilelabs.com/api/distributors/${id}/detail?${qs.toString()}`,
    {
      headers: authHeaders(token),
    }
  );
...
export async function assignCustomerToDistributor(
  ...
  const res = await fetch(
    `https://trx-api.theagilelabs.com/api/distributors/customers/${customerId}/assign`,
    {
      method: "PATCH",
      headers: authHeaders(token),
...
export async function unassignCustomerFromDistributor(
  ...
  const res = await fetch(
    `https://trx-api.theagilelabs.com/api/distributors/customers/${customerId}/unassign`,
    {
      method: "PATCH",
      headers: authHeaders(token),
    }
