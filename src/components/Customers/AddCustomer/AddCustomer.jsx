...
const AddCustomer = () => {
  ...
  const fetchAreas = async (companyId) => {
    try {
      const response = await fetch(`https://trx-api.linarawas.com/api/areas/company/${companyId}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://trx-api.linarawas.com/api/customers', {
        method: 'POST',
        headers: {
