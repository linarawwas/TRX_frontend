    ...
    return (
        <>
            <div className="feature-section">
                <h2>Key Features</h2>
                <ul>
                    <li className='show-form-li' onClick={() => { setShowShipmentForm(!showShipmentForm) }}>Start a new shipment</li>
                    <li className='show-form-li' onClick={() => { setShowProfitsForm(!showProfitsForm) }}>Add Extra Profits</li>
                    <li className='show-form-li' onClick={() => { setShowExpensesForm(!showExpensesForm) }}>Add Expenses</li>
                </ul>
            </div>
