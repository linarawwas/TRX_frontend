...
export const AddPaymentForm = (props) => {
    ...
    const handleAddPayment = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`https://api-trx.linarawas.com/api/orders/addPayment/${orderId}`, {
                method: 'PUT',
                headers: {
            ...
            if (response.ok) {
                ...
                const updatedOrderResponse = await fetch(`https://api-trx.linarawas.com/api/orders/${orderId}`, {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                });
