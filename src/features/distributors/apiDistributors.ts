...
export async function listDistributors(token: string) {
  return requestJson<DistributorRecord[]>("/api/distributors", {
    token,
...
export async function distributorsSummary(token: string, range: DateRange) {
  return requestJson(withRange("/api/distributors/summary", range), {
    token,
...
export async function createDistributor(
  ...
  return requestJson("/api/distributors", {
    token,
    method: "POST",
    jsonBody: payload,
...
export async function updateDistributor(
  ...
  return requestJson(`/api/distributors/${id}`, {
    token,
    method: "PATCH",
    jsonBody: payload,
...
export async function distributorCustomers(token: string, id: string) {
  return requestJson(`/api/distributors/${id}/customers`, {
    token,
...
export async function distributorSummary(
  ...
  return requestJson(withRange(`/api/distributors/${id}/detail`, range), {
    token,
...
export async function assignCustomerToDistributor(
  ...
  return requestJson(`/api/distributors/customers/${customerId}/assign`, {
    token,
    method: "PATCH",
...
export async function unassignCustomerFromDistributor(
  ...
  return requestJson(`/api/distributors/customers/${customerId}/unassign`, {
    token,
    method: "PATCH",
